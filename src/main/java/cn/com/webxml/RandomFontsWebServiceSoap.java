...
public interface RandomFontsWebServiceSoap {
    ...
    @RequestWrapper(localName = "getCharFonts", targetNamespace = "http://WebXml.com.cn/", className = "cn.com.webxml.GetCharFonts")
    @WebMethod(action = "http://WebXml.com.cn/getCharFonts")
    @ResponseWrapper(localName = "getCharFontsResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.com.webxml.GetCharFontsResponse")
    public cn.com.webxml.ArrayOfString getCharFonts(
    ...
    @RequestWrapper(localName = "getChineseFonts", targetNamespace = "http://WebXml.com.cn/", className = "cn.com.webxml.GetChineseFonts")
    @WebMethod(action = "http://WebXml.com.cn/getChineseFonts")
    @ResponseWrapper(localName = "getChineseFontsResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.com.webxml.GetChineseFontsResponse")
    public cn.com.webxml.ArrayOfString getChineseFonts(
        @WebParam(name = "byFontsLength", targetNamespace = "http://WebXml.com.cn/")
        int byFontsLength
    );
}
